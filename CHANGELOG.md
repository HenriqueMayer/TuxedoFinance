...
- Keep unsaved-form departure warnings active when a user starts editing before HTMX finishes settling a newly opened page.
...
[Unreleased]: https://github.com/HenriqueMayer/TuxedoFinance/compare/v0.6.1...HEAD
